...
lyr_SUNGAI_LN_25K_2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'NAMOBJ': 'Nama Objek', 'FCODE': 'Feature Code', 'REMARK': 'Catatan', 'METADATA': 'METADATA', 'SRS_ID': 'Spatial Reference System Identifier', 'ADATGL': 'Keberadaan Tanggul
', 'DMAX': 'Kelerengan Rata-rata
', 'FNGAIR': 'Manfaat Air', 'JNSSNG': 'Tipe Sungai
', 'KLSSNG': 'Ordo Sungai
', 'LTKSGI': 'Letak Sungai
', 'NAMWS': 'Nama Wilayah Sungai
', 'STATUS': 'Status
', 'UKRSGI': 'Ukuran Sungai
', 'WMAX': 'Lebar Maksimum
', 'DBTMXS': 'Debit Maksimal Sungai', 'NAMDAS': 'NAMDAS', 'SHAPE_Length': 'SHAPE_Length', });
...
', });
lyr_RUMAHSAKIT_PT_25K_4.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'NAMOBJ': 'Nama Objek', 'FCODE': 'Feature Code', 'REMARK': 'CATATAN', 'METADATA': 'METADATA', 'SRS_ID': 'Spatial Reference System Identifier', 'JPLYRS': 'Jenis Pelayanan Rumah Sakit
', 'RSALAMAT': 'Alamat Rumah Sakit
', 'TIPRST': 'Tipe Rumah Sakit
', });
lyr_PENDIDIKAN_PT_25K_5.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'NAMOBJ': 'Nama Objek', 'FCODE': 'Feature Code', 'REMARK': 'CATATAN', 'METADATA': 'METADATA', 'SRS_ID': 'Spatial Reference System Identifier', 'KODEBP': 'Bentuk Pendidikan', 'STSPML': 'Status Kepemilikan', 'JJGPDF': 'Jenjang Pendidikan



', 'JLPDDK': 'Jalur Pendidikan



', 'JNSPDK': 'Jenis Pendidikan
...
', 'FGDPDK': 'Fungsi Gedung Penddikan', });
...
lyr_JALAN_LN_25K_7.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'NAMOBJ': 'Nama Objek', 'FCODE': 'Feature Code', 'REMARK': 'Catatan', 'METADATA': 'METADATA', 'SRS_ID': 'Spatial Reference System Identifier', 'ARHRJL': 'Arah Jalan
', 'AUTRJL': 'Status Jalan', 'FGSRJL': 'Fungsi Jalan
', 'JARRJL': 'Sistem Jaringan Jalan', 'JPARJL': 'Jumlah Lajur
', 'KLLRJL': 'Pengelola Ruas Jalan', 'KONRJL': 'Kondisi Fisik
', 'KPMSTR': 'Kapasitas Muatan Sumbu Terberat (MST)
', 'LKONOF': 'Lokasi On/Off Ramp
', 'LKSBSP': 'Lokasi Black Spot
', 'LKSRTA': 'Lokasi Rest Area
', 'LLHRRT': 'Lalulintas Harian Rata-rata Tahunan
', 'LOCRJL': 'kelas jalan berdasarkan posisinya
', 'LBRBHJ': 'Lebar Rata-rata Bahu Jalan
', 'LBRJLN': 'Lebar Rata-rata Perkerasan Jalan
', 'MATRJL': 'Tipe Bahan
', 'MEDRJL': 'Pembatas Jalan
', 'SPCRJL': 'Spesifikasi Jaringan Jalan
', 'STARJL': 'Status Pembangunan Jalan', 'TOLRJL': 'Jalan Tol
', 'UTKRJL': 'Peruntukan Jalan', 'VLCPRT': 'Volume Capacity Ratio (VCR)
', 'WLYRJL': 'Wilayah Pelayanan Jalan
', 'TGL_SK': 'Tanggal SK', 'JLNLYG': 'Jalan Layang

', 'KLSRJL': 'KLSRJL', 'SHAPE_Length': 'SHAPE_Length', });
lyr_JEMBATAN_PT_25K_8.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'NAMOBJ': 'Nama Objek', 'FCODE': 'Feature Code', 'REMARK': 'CATATAN', 'METADATA': 'METADATA', 'SRS_ID': 'Spatial Reference System Identifier', 'AYUJMB': 'Kemampuan Jembatan
', 'BTSJMB': 'Tipe Jembatan BAT
', 'DEKJMB': 'Tipe Dek
', 'FGSJMB': 'Fungsi Jembatan
', 'JMLBTG': 'Jumlah Bentang
', 'KDBBWH': 'Kondisi Bangunan Bawah
', 'KDBGAT': 'Kondisi Bangunan Atas
', 'KDLNTI': 'Kondisi Lantai
', 'KDUJMB': 'Kondisi Umum Jembatan 
', 'LBRJMB': 'Lebar Jembatan
', 'LBRTRT': 'Lebar Trotoar
', 'MATJMB': 'Bahan Jembatan
', 'TBGNAT': 'Tipe Bangunan Atas
', 'TGRNBS': 'Clearance (Tinggi Ruang Bebas)
', 'THNPBN': 'Tahun Pembangunan
', 'TIPJMB': 'Tipe Jembatan
', 'TONJMB': 'Tonasi
', 'STRJMB': 'Struktur Sistem Jembatan
